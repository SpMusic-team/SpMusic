...
| `docs/requirements/v0-1-foundation.md` | 已批准为 v0.1 版本需求 | 项目地基阶段的需求、非目标和验收标准 |
...
v0.1 的目标不是实现完整播放器，而是将当前 Tauri + React + TypeScript 模板项目收敛为可运行、可验证、边界清晰的 SpMusic 项目地基。
...
- 空队列 Empty State。
- 最小 Tauri command，用于验证 React 到 Rust 的通信链路。
- 基础工程验收命令和人工检查清单。
...
| ID | 需求 | 优先级 | 状态 | 来源 |
| --- | --- | --- | --- | --- |
| REQ-FOUNDATION-001 | 项目身份与文档地基 | P0 | Approved | `docs/requirements/v0-1-foundation.md` |
| REQ-FOUNDATION-002 | 静态播放器主界面 | P1 | Approved | `docs/requirements/v0-1-foundation.md` |
| REQ-FOUNDATION-003 | UI-only 播放状态模型 | P1 | Approved | `docs/requirements/v0-1-foundation.md` |
| REQ-FOUNDATION-004 | 最小 Tauri 通信验证 | P1 | Approved | `docs/requirements/v0-1-foundation.md` |
