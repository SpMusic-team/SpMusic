...
export const iosSystemIcons: SystemIconProvider = {
  ...
  volume: libraryIcon(Speaker as ComponentType<AnyIconProps>, { pitch: 'high' }),
  volumeMedium: libraryIcon(Speaker as ComponentType<AnyIconProps>, { pitch: 'normal' }),
  volumeLow: libraryIcon(Speaker as ComponentType<AnyIconProps>, { pitch: 'low' }),
  volumeMuted: libraryIcon(Speaker as ComponentType<AnyIconProps>, { disabled: true }),
